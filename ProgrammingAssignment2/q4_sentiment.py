...
### YOUR CODE HERE
REGULARIZATION = np.logspace(-6,0.1,22)
...
print "The best regularization value is: %E" % BEST_REGULARIZATION
print "This is the testing accuracy (%%): %f" % accuracy(testLabels, pred)
...
plt.savefig("q4_regz_accuracy.png")
plt.show()
