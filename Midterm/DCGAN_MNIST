...
from keras.layers.convolutional import Convolution1D, UpSampling1D, Convolution2D, UpSampling2D
...
'''This is to control discriminator and generator training. 
...
#This freezes training of the D for stacked training of G

make_trainable(discriminator, False)

#This is the complete GAN model
...
#This is to pre-train the discriminator network
...
#This is to try for different learning rates
